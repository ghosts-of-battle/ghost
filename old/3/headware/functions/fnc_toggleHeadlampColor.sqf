...
private _preset = (configFile >> 'Headlamps_Presets' >> _presetName);
...
private _currentCycleIndex = _colorCycle find _currentLampVariant;
private _nextIndex = (_currentCycleIndex + 1) mod (count _colorCycle);
