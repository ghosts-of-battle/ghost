 ...
 *
 * Example:
 * call ghost_bft_fnc_trackingUpdate
 *
 * Public: No
 */

if ((isNil "ghost_unit") && (!alive ghost_unit)) exitWith {};
...
if (GVAR(requireItemGPS) && !([ghost_unit] call FUNC(hasGPSDevice))) exitWith {};
