...
_ctrlMap ctrlSetPosition [_ctrlGrpX, _ctrlGrpY, _ctrlGrpWidth, _ctrlGrpHeight - (2.2 * GHOST_ADMINMENU_STD_HEIGHT)];
...
_ctrlCheckDrawAllSides ctrlSetPosition [_ctrlGrpX, _ctrlGrpY + _ctrlGrpHeight - (2.2 * GHOST_ADMINMENU_STD_HEIGHT), GHOST_ADMINMENU_STD_WIDTH, GHOST_ADMINMENU_STD_HEIGHT];
...
_ctrlLabelDrawAllSides ctrlSetPosition [_ctrlGrpX + GHOST_ADMINMENU_STD_WIDTH, _ctrlGrpY + _ctrlGrpHeight - (2.2 * GHOST_ADMINMENU_STD_HEIGHT), (0.2 * _ctrlGrpWidth) - GHOST_ADMINMENU_STD_WIDTH, GHOST_ADMINMENU_STD_HEIGHT];
_ctrlLabelDrawAllSides ctrlCommit 0;
_ctrlLabelDrawAllSides ctrlSetText "Draw enemy units on map";

//private _paradropCheckX = (ctrlPosition _ctrlLabelDrawAllSides) select 0 + ctrlTextWidth _ctrlLabelDrawAllSides + GHOST_ADMINMENU_STD_WIDTH;
...
_ctrlCheckParadropInfantry ctrlSetPosition [_ctrlGrpX + (0.2 * _ctrlGrpWidth), _ctrlGrpY + _ctrlGrpHeight - (2.2 * GHOST_ADMINMENU_STD_HEIGHT), GHOST_ADMINMENU_STD_WIDTH, GHOST_ADMINMENU_STD_HEIGHT];
...
_ctrlLabelParadropInfantry ctrlSetPosition [_ctrlGrpX + (0.2 * _ctrlGrpWidth) + GHOST_ADMINMENU_STD_WIDTH, _ctrlGrpY + _ctrlGrpHeight - (2.2 * GHOST_ADMINMENU_STD_HEIGHT), (0.2 * _ctrlGrpWidth) - GHOST_ADMINMENU_STD_WIDTH, GHOST_ADMINMENU_STD_HEIGHT];
...
_ctrlHint ctrlSetPosition [_ctrlGrpX, _ctrlGrpY + _ctrlGrpHeight - GHOST_ADMINMENU_STD_HEIGHT, 0.8 * _ctrlGrpWidth, GHOST_ADMINMENU_STD_HEIGHT];
...
_ctrlButton ctrlSetPosition [_ctrlGrpX + 0.8 * _ctrlGrpWidth, _ctrlGrpY + _ctrlGrpHeight - GHOST_ADMINMENU_STD_HEIGHT, 0.2 * _ctrlGrpWidth, GHOST_ADMINMENU_STD_HEIGHT];
