...
class CfgPatches {
	class MRHMiscItems{
		units[] = {"MRH_USB_ThumbDrive","MRH_emptyBox","MRH_emptySupplyBox","MRH_AcexFoodSuppliesCrate","MRH_MedicalTent","MRH_MedicalTent_Special","MRH_FOB_container","MRH_camp_container","GHOST_laser_designator","MRH_MT_protectiveCase","MRH_empty_protectiveCase","MRH_TrashBin","MRH_PRC117","MRH_BigGreenBox","MRH_projectionScreenSmall","MRH_projectionScreenLarge","MRH_PRC152","B_MRH_117FRadioStation","O_MRH_117FRadioStation","I_MRH_117FRadioStation","C_MRH_117FRadioStation","MRH_MT_SatCom_Antenna"}; //
		weapons[] = {"MRH_FoldedMedicalTent","GHOST_ShootingMat_Base","GHOST_ShootingMat_Khaki","GHOST_ShootingMat_Olive","GHOST_laser_designator","MRH_KeyCard_BLUFOR","MRH_KeyCard_OPFOR","MRH_KeyCard_IND","GHOST_MT_FoldedSatcomAntenna"}; //
		requiredVersion = 0.1; //
