...
There is a chance (set in the DFC module) that each time an objective is cancelled, the enemy will counter-attack with all available land vehicles. Note that objectives can be recaptured by the AI.
