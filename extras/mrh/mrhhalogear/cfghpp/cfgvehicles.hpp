...
class GHOST_AADEquippedParachute : B_Parachute {
	displayName = $STR_MRH_MRHHaloGear_AADChute;
	scope = 2;
};
class ACE_NonSteerableParachute;
class GHOST_AADEquippedNSParachute : ACE_NonSteerableParachute {
    ...
    class ACE_Actions { \
       class ACE_MainActions  { \
					class MRH_AttachAAD { \
						...
						condition = "(!(_target getVariable ['MRH_HaloGear_itemAsAAD',false]) && ('GHOST_AAD_Item' in items _player))"; \
						statement = "_target setVariable ['MRH_HaloGear_itemAsAAD',true,true]; _player removeItem 'GHOST_AAD_Item'; hint localize 'STR_MRH_MRHHaloGear_HintAADAdded';"; \
					...
					class MRH_DetachAAD { \
						...
						statement = "[_target] call MRH_fnc_MilsimTools_HaloGear_removeObjectAAD; _player addItem 'GHOST_AAD_Item'; hint localize 'STR_MRH_MRHHaloGear_HintAADRemoved';"; \
						exceptions[] = {"isNotSwimming"}; \
						showDisabled = 0; \
						icon = ""; \
					}; \
