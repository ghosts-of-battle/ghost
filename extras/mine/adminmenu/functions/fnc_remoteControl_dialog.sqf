...
_ctrlList ctrlSetPosition [(_dialogPosition # 0) + 0.1 * GHOST_ADMINMENU_STD_WIDTH, (_dialogPosition # 1) + 0.1 * GHOST_ADMINMENU_STD_HEIGHT, (_dialogPosition # 2) - (0.2 * GHOST_ADMINMENU_STD_WIDTH), (_dialogPosition # 3) - (0.2 * GHOST_ADMINMENU_STD_HEIGHT)];
...
_ctrlOK ctrlSetPosition [(_dialogPosition # 0) + 0.67 * (_dialogPosition # 2), (_dialogPosition # 1) + (_dialogPosition # 3) + 0.1 * GHOST_ADMINMENU_STD_HEIGHT, 0.33 * (_dialogPosition # 2), GHOST_ADMINMENU_STD_HEIGHT];
