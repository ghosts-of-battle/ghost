...
class cfgScriptPaths {
    GHOST_briefing = "z\ghost\addons\briefing\ui_scripts\"; //" - Escape for VS code linter
};

class Cfg3DEN {
    class Mission {
        class GHOST_MissionBriefingAttributes {
            displayName = "GHOST Briefing settings"; // Text visible in the window title as "Edit <displayName>"
            ...
            class AttributeCategories {
                class GHOST_BriefingSettings {
                    displayName = "GHOST: Briefing settings"; // Category name visible in Edit Attributes window
                    collapsed = 0; // When 1, the category is collapsed by default
                    class Attributes {
                        class GHOST_Briefing_Loadout {
                            property = "GHOST_Briefing_Loadout";
                            ...
                            control = "Checkbox";
                            //expression = "missionNamespace setVariable ['GHOST_Briefing_Loadout',_value];";
                            defaultValue = "false";
                            condition = "1";
                        };
                        class GHOST_Briefing {
                            property = "GHOST_Briefing";
                            displayName = "";
                            control = "BriefingSettings";
                            //expression = "missionNamespace setVariable ['GHOST_BriefingArray',_value];";
    ...
    class Group {
        ...
        class AttributeCategories {
            ...
            class GhostMarker {
                class Attributes {
                    class GHOST_Briefinglist {
                        displayName = ""; // Name assigned to UI control class Title
                        tooltip = ""; // Tooltip assigned to UI control class Title
                        property = "GHOST_Briefinglist"; // Unique config property name saved in SQM
                        control = "None"; // UI control base class displayed in Edit Attributes window, points to Cfg3DEN >> Attributes
                        expression =  "[_this,'GHOST_Briefinglist',_value] call ghost_common_fnc_initGroupVar;";// "_this setVariable ['GHOST_Briefinglist',_value],true;";
                        defaultValue = "[]";
                        wikiType = "[[String]]";
                    };
                };
            ...
            class GhostMarker {
                class Attributes {
                    class GHOST_Briefinglist {
                        ...
                        property = "GHOST_Briefinglist"; // Unique config property name saved in SQM
                        control = "None"; // UI control base class displayed in Edit Attributes window, points to Cfg3DEN >> Attributes
                        expression = "_this setVariable ['GHOST_Briefinglist',_value,true];";
                        defaultValue = "[]";
                        wikiType = "[[String]]";
    ...
    class Attributes {
        ...
        class BriefingSettings : Toolbox {
            ...
            scriptPath = "GHOST_briefing";
            onLoad = "['onLoad',_this,'BriefingSettings','GHOST_briefing',false] call (uinamespace getvariable 'BIS_fnc_initDisplay');"; // 3rd param is the path PATH\scriptName.sqf
            onUnload = "['onUnload',_this,'BriefingSettings','GHOST_briefing',false] call (uinamespace getvariable 'BIS_fnc_initDisplay');";
