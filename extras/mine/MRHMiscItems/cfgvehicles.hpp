        ...
        class ACE_SelfActions 
		{
			class ACE_Equipment {
				...
				class MRH_Ace_UnFoldShootingMatKhaki
				{
					...
					condition = "('GHOST_ShootingMat_Khaki' in items MRH_player)";
				...
				{
					displayName = $STR_MRH_MRHMiscItems_UnfoldSM;
					condition = "('GHOST_ShootingMat_Olive' in items MRH_player)";
					exceptions[] = {"isNotSitting"};
				...
				class MRH_Ace_UnpackLaserDesignator
				{
					...
					condition = "('GHOST_laser_designator' in items MRH_player)";
					exceptions[] = {"isNotSitting"};
				...
				class MRH_Ace_unfoldSatcomAntenna
				{
					...
					condition = "('GHOST_MT_FoldedSatcomAntenna' in items MRH_player)";
					exceptions[] = {"isNotSitting"};
...
class GHOST_laser_designator : B_W_Static_Designator_01_F //Static_Designator_01_base_F//
{
