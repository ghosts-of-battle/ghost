...
_ctrlLabelTraits ctrlSetPosition [0, 0, (0.25 * _ctrlGrpWidth), GHOST_ADMINMENU_STD_HEIGHT];
...
private _ctrlComboTraitY = 2.2 * GHOST_ADMINMENU_STD_HEIGHT;
private _ctrlComboTraitW = 0.5 * _ctrlGrpWidth;
private _traitComboCtrls = [];

{
    private _ctrlLineY = _ctrlComboTraitY + _forEachIndex * (1.1 * GHOST_ADMINMENU_STD_HEIGHT);
    ...
    _ctrlComboTraitLabel ctrlSetPosition [0.1 * GHOST_ADMINMENU_STD_WIDTH, _ctrlLineY, _ctrlComboTraitLabelW, GHOST_ADMINMENU_STD_HEIGHT];
    ...
    _ctrlComboTrait ctrlSetPosition [_ctrlComboTraitX, _ctrlLineY, _ctrlComboTraitW, GHOST_ADMINMENU_STD_HEIGHT];
