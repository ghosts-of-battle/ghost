...
_ctrlLabelRadios ctrlSetPosition [0, 0, (0.5 * _ctrlGrpWidth), GHOST_ADMINMENU_STD_HEIGHT];
...
_ctrlLabelRadioGroup ctrlSetPosition [0, (1.1 * GHOST_ADMINMENU_STD_HEIGHT), 0.5 * _ctrlGrpWidth, GHOST_ADMINMENU_STD_HEIGHT];
...
private _radioCtrls = [];
private _radioCtrlsY = 2.2 * GHOST_ADMINMENU_STD_HEIGHT;

{
    ...
    _ctrlRadioCheck ctrlSetPosition [0, _radioCtrlsY + (_forEachIndex * GHOST_ADMINMENU_STD_HEIGHT), GHOST_ADMINMENU_STD_WIDTH, GHOST_ADMINMENU_STD_HEIGHT];
    ...
    _ctrlRadioName ctrlSetPosition [GHOST_ADMINMENU_STD_WIDTH, _radioCtrlsY + (_forEachIndex * GHOST_ADMINMENU_STD_HEIGHT), (0.5 * _ctrlGrpWidth) - GHOST_ADMINMENU_STD_WIDTH, GHOST_ADMINMENU_STD_HEIGHT];
...
if (!isNil QEGVAR(acre2,networksWithRadioChannels)) then {
    ...
    _ctrlCheckNetwork ctrlSetPosition [0.5 * _ctrlGrpWidth, 0, GHOST_ADMINMENU_STD_WIDTH, GHOST_ADMINMENU_STD_HEIGHT];
    ...
    _ctrlLabelNetwork ctrlSetPosition [(0.5 * _ctrlGrpWidth) + GHOST_ADMINMENU_STD_WIDTH, 0, (0.5 * _ctrlGrpWidth) - (1.1 * GHOST_ADMINMENU_STD_WIDTH), GHOST_ADMINMENU_STD_HEIGHT];
    ...
    _ctrlLabelNetworkWarning ctrlSetPosition [0.5 * _ctrlGrpWidth, (1.1 * GHOST_ADMINMENU_STD_HEIGHT), 0.5 * _ctrlGrpWidth, GHOST_ADMINMENU_STD_HEIGHT];
    ...
    _ctrlListNetwork ctrlSetPosition [0.5 * _ctrlGrpWidth, _radioCtrlsY, (0.5 * _ctrlGrpWidth) - (0.1 * GHOST_ADMINMENU_STD_WIDTH), _ctrlGrpHeight - _radioCtrlsY - (2 * GHOST_ADMINMENU_STD_HEIGHT)];
