...
/* ----------------------------------------------------------------------------
Function: ghost_electronic_war_zones_fnc_spawnZoneAt
...
Example:
    [_basePos, 900, "Land_TTowerBig_2_F"] call ghost_electronic_war_zones_fnc_spawnZoneAt
...
if (_class isNotEqualTo "" && {isNull _obj}) exitWith {
    WARNING_1("Electronic War Zones: emitter '%1' missing or failed to create - no zone registered.",_class);
    ["", objNull]
};
...
INFO_3("Electronic War Zones: zone %1 placed at %2, radius %3",_id,mapGridPosition _pos,round _radius);
