...
private _fnc_onConfirm = {
    ...
    private _logicObject = missionnamespace getvariable ["BIS_fnc_initCuratorAttributes_target", objnull];
    if (isNull _logicObject) exitWith {diag_log text format ["[GHOST] - ERROR Logic [%1] is null on confirm", _logicObject];};
    ...
    private _debugMsg = format ["Sending Hint to %1", _selectedSide];
    ["ghost_missionHint", [_textInput, _selectedSide, _selectedRank]] call CBA_fnc_globalEvent;
