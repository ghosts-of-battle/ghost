...
[{
    ...
    switch (_this) do {
        case 1: {
            ["ghost_w_rifleman" , "Init", { [_this, 1] call FUNC(identity_set) }, true, nil, true] call CBA_fnc_addClassEventHandler;
        };
        case 2: {
            ["ghost_e_rifleman" , "Init", { [_this, 2] call FUNC(identity_set) }, true, nil, true] call CBA_fnc_addClassEventHandler;
        };
        case 3: {
            ["ghost_i_rifleman" , "Init", { [_this, 3] call FUNC(identity_set) }, true, nil, true] call CBA_fnc_addClassEventHandler;
        };
        case 4: {
