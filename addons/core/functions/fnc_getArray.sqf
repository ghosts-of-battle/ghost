 ...
 *
 * Examples:
 * [configFile >> "thisIsAnArray"] call ghost_core_fnc_getArray; // returns value in path
 * [configFile >> "thisIsNotAnArray"] call ghost_core_fnc_getArray; // returns []
 * [configFile >> "thisIsAnArray", ['default']] call ghost_core_fnc_getArray; // returns value in path
 * [configFile >> "thisIsNotAnArray", ['default']] call ghost_core_fnc_getArray; // returns ['default']
 *
 * Public: Yes
 */
