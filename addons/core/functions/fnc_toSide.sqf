 ...
 *
 * Examples:
 * [1] call ghost_core_fnc_toSide; // returns west
 * [99] call ghost_core_fnc_toSide; // returns sideUnknown
 * ["east"] call ghost_core_fnc_toSide; // returns east
 *
 * Public: Yes
 */
...
if (_toConvert isEqualType 0) exitWith {
...
if (_toConvert isEqualType "") exitWith {
