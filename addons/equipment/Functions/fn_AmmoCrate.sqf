/*
Function name:GHOST_fnc_GHOST_fnc_AmmoCrate;
Author: Mr H.
...
Example(s):
[this,10,true,true] call GHOST_fnc_AmmoCrate;
*/
...
_box setVariable ["GHOST_AmmoCrateParameters", _params, true];
...
_statement =
 ...
 _box = _this select 0;
 _params = _box getVariable "GHOST_AmmoCrateParameters";
 [[_params],
  {
  params ["_params"];
  _box = _params select 0;
  _handlerIndex = _box getVariable "GHOST_AmmoCrateEHIndex";
  ...
  _params call GHOST_fnc_AmmoCrate;
  }
