/*
Function: GHOST_fnc_LimitedArsenal
...
Description:
 ...
 GHOST_fnc_Arsenal, only the items in the container change.
...
Examples:
 (begin example)
  [this] call GHOST_fnc_LimitedArsenal;
  [this, "Aegis", 50] call GHOST_fnc_LimitedArsenal;
  [this, "VANILLA"] call GHOST_fnc_LimitedArsenal;
  [MyAmmoCrate, "RHS", 0] call GHOST_fnc_LimitedArsenal;
 (end)
