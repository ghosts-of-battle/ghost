...
/* ----------------------------------------------------------------------------
Function: GHOST_adminmenu_fnc_log
...
Examples:
    (begin example)
        ["Everything is on fire!",true,"[Ghosts of Battle Firealarm]"] call GHOST_adminmenu_fnc_log;
    (end)
    (begin example)
        [format ["%1 did something",profileName]] call GHOST_adminmenu_fnc_log;
    (end)
