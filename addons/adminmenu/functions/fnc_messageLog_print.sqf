...
/* ----------------------------------------------------------------------------
Internal Function: GHOST_adminmenu_fnc_messageLog_print
...
Examples:
    (begin example)
        [_ctrl] call GHOST_adminmenu_fnc_messageLog_print;
    (end)
...
private _lbCtrl = _display displayCtrl IDC_GHOST_ADMINMENU_MSGS_LIST;
