...
} forEach IDCS_GHOST_ADMINMENU_UTIL;
...
private _ctrlFilterSide = _display displayCtrl IDC_GHOST_ADMINMENU_PMAN_FILTER_SIDE;
{
...
private _ctrlFilterState = _display displayCtrl IDC_GHOST_ADMINMENU_PMAN_FILTER_STATE;
{
...
private _ctrlReset = _display displayCtrl IDC_GHOST_ADMINMENU_PMAN_FILTER_RESET;
_ctrlReset ctrlAddEventHandler ["ButtonClick", {
    params ["_ctrlButton"];
    _ctrlButton call FUNC(debounceButton);

    private _display = ctrlParent _ctrlButton;
    (_display displayCtrl IDC_GHOST_ADMINMENU_PMAN_FILTER_SIDE) lbSetCurSel 0;
    (_display displayCtrl IDC_GHOST_ADMINMENU_PMAN_FILTER_STATE) lbSetCurSel 0;
    _display call FUNC(playerManagement_updateList);
}];

private _ctrlRefresh = _display displayCtrl IDC_GHOST_ADMINMENU_PMAN_REFRESH;
...
private _ctrlSelectAll = _display displayCtrl IDC_GHOST_ADMINMENU_PMAN_SEL_ALL;
_ctrlSelectAll ctrlAddEventHandler ["ButtonClick", {
    params ["_ctrlButton"];
    _ctrlButton call FUNC(debounceButton);

    private _display = ctrlParent _ctrlButton;
    private _ctrlList = _display displayCtrl IDC_GHOST_ADMINMENU_PMAN_LIST;
...
private _ctrlSelectNone = _display displayCtrl IDC_GHOST_ADMINMENU_PMAN_SEL_NONE;
...
private _ctrlSelectInvert = _display displayCtrl IDC_GHOST_ADMINMENU_PMAN_SEL_INVERT;
