class Controls
{
    ...
    {
        idc = IDC_GHOST_ADMINMENU_RESP_SPECTATORTEXT;
        ...
        x = 0;
        y = 0;
        w = QUOTE(GHOST_ADMINMENU_RESP_W_COL1);
        h = QUOTE(GHOST_ADMINMENU_STD_HEIGHT);
    };
    class spectatorListBox: RscListBox
    {
        idc = IDC_GHOST_ADMINMENU_RESP_SPECTATORLIST;
        
        sizeEx = QUOTE(GHOST_ADMINMENU_STD_SIZEX);
        sizeEx2 = QUOTE(GHOST_ADMINMENU_STD_SIZEX);
    ...
    {
        idc = IDC_GHOST_ADMINMENU_RESP_ADDBUTTON;
        text = "Add";
        x = QUOTE(GHOST_ADMINMENU_RESP_X_COL2);
        y = "1.1 * ((((safezoneW / safezoneH) min 1.2) / 1.2) / 25) + (safezoneY + (safezoneH - (((safezoneW / safezoneH) min 1.2) / 1.2))/2)";
        w = QUOTE(GHOST_ADMINMENU_RESP_W_COL2);
        h = QUOTE(GHOST_ADMINMENU_STD_HEIGHT);
        onButtonClick=QUOTE((ctrlParent (param [0])) call FUNC(respawn_addAction));
    };
    class respawnMenuRemoveButton: GVAR(RscButtonMenu)
    {
        idc = IDC_GHOST_ADMINMENU_RESP_REMOVEBUTTON;
        text = "Remove";
        x = QUOTE(GHOST_ADMINMENU_RESP_X_COL2);
    ...
    {
        idc = IDC_GHOST_ADMINMENU_RESP_ROLECOMBO;
        text = "Role";
    ...
    {
        idc = IDC_GHOST_ADMINMENU_RESP_RANK;
    ...
    class respawnGroupDetailsText: RscText
    {
        ...
        x = QUOTE(GHOST_ADMINMENU_RESP_X_COL4);
        y = "1.1 * ((((safezoneW / safezoneH) min 1.2) / 1.2) / 25) + (safezoneY + (safezoneH - (((safezoneW / safezoneH) min 1.2) / 1.2))/2)";
        w = QUOTE(GHOST_ADMINMENU_RESP_W_COL1);
        h = QUOTE(GHOST_ADMINMENU_STD_HEIGHT);
    };
    ...
    {
        idc = IDC_GHOST_ADMINMENU_RESP_GROUPNAME;
        ...
        x = QUOTE(GHOST_ADMINMENU_RESP_X_COL4);
        y = "2.2 * ((((safezoneW / safezoneH) min 1.2) / 1.2) / 25) + (safezoneY + (safezoneH - (((safezoneW / safezoneH) min 1.2) / 1.2))/2)";
        w = QUOTE(GHOST_ADMINMENU_RESP_W_COL4);
        h = QUOTE(GHOST_ADMINMENU_STD_HEIGHT);
    };
    class respawnMenuFactionCategoryCombo: RscCombo
    {
        idc = IDC_GHOST_ADMINMENU_RESP_FACTIONCATEGORY;
    ...
    {
        idc = IDC_GHOST_ADMINMENU_RESP_FACTION;
        text = "Faction";
    ...
    {
        idc = IDC_GHOST_ADMINMENU_RESP_SIDE;
        text = "Side";
    ...
    {
        idc = IDC_GHOST_ADMINMENU_RESP_GROUPMARKERCHECKBOX;
        text = "Give group marker";
        x = QUOTE(GHOST_ADMINMENU_RESP_X_COL4 + (7 * (((safezoneW / safezoneH) min 1.2) / 40)));
        y = "7.7 * ((((safezoneW / safezoneH) min 1.2) / 1.2) / 25) + (safezoneY + (safezoneH - (((safezoneW / safezoneH) min 1.2) / 1.2))/2)";
        w = "(1 * (((safezoneW / safezoneH) min 1.2) / 40))";
        h = QUOTE(GHOST_ADMINMENU_STD_HEIGHT);
        //action = "['respawnMenuToggleGroupCheckbox'] spawn ghost_respawn_fnc_handleRespawnUI";
    };
    class respawnMenuMarkerName: RscEdit
    {
        idc = IDC_GHOST_ADMINMENU_RESP_GROUPMARKERNAME;
    ...
    {
        idc = IDC_GHOST_ADMINMENU_RESP_MARKERTYPE;
        text = "Side";
    ...
    {
        idc = IDC_GHOST_ADMINMENU_RESP_MARKERCOLOUR;
        text = "Side";
    ...
    {
        idc = IDC_GHOST_ADMINMENU_RESP_SPAWNBUTTON;
        text = "Spawn Group";
        x = QUOTE(GHOST_ADMINMENU_RESP_X_COL4);
    ...
    // {
        ...
        // h = 0.055 * safezoneH;
        // action="['respawnMenuChangeRoleAction'] spawn ghost_respawn_fnc_handleRespawnUI";
    // };
    ...
    // {
        ...
        // w = 0.0567187 * safezoneW;
        // h = 0.055 * safezoneH;
        // action="['respawnMenuChangeRankAction'] spawn ghost_respawn_fnc_handleRespawnUI";
    // };
};
