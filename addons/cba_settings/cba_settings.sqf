...
// ACE Pharmacy - AED
force aceP_circulation_CPR_Chance_Default = 30;
force aceP_circulation_CPR_Chance_Doctor = 50;
force aceP_circulation_CPR_Chance_RegularMedic = 40;
...
force aceP_circulation_aiEnableAdvanced = true;
force aceP_circulation_blockChance = 20;
force aceP_circulation_coagulation = true;
force aceP_circulation_factorDrugs = 1;
...
force aceP_circulation_surgicalDrugs = 1;
...
force ctab_main_bft_mode = 1;
force ctab_main_defMapStyle = "SAT";
force ctab_main_gridPrecision = 2;
force ctab_main_helmetcam_mode = 1;
force ctab_main_sync_time = 60;
force ctab_main_uav_mode = 1;
force ctab_main_useAceMicroDagr = true;
force ctab_main_useArmaMarker = true;
ctab_main_useMils = false;
...
// GHOST - common
force ghostb_Main_DynamicGroups = true;
force ghostb_Main_DynamicSim = true;
force ghostb_Main_FlipVehicle = true;
...
// GHOST - Suppress
force ghost_suppress_checkLOS = true;
force ghost_suppress_overlayFadeoutTime = 10;
force ghost_suppress_overlayOpacity = 0.96;
force ghost_suppress_overlayTexture = 0;
force ghost_suppress_projectileMaxDistance = 9;
force ghost_suppress_shooterMinDistance = 0;

// Ghosts of Battle - ACRE
ghost_acre_addArsenalCategory = true;
force ghost_acre_babel = true;
force ghost_acre_enabled = true;
force ghost_acre_perSideChannelNames = true;
force ghost_acre_perSideRadios = true;
force ghost_acre_startBppVolume = 2;
force ghost_acre_startLeaderVolume = 2;
force ghost_acre_WESTChannelName1 = "COMNET";
force ghost_acre_WESTChannelName10 = "DETNET_3-2";
force ghost_acre_WESTChannelName11 = "DETNET_A";
force ghost_acre_WESTChannelName12 = "DETNET_A-1";
force ghost_acre_WESTChannelName13 = "DETNET_A-2";
force ghost_acre_WESTChannelName14 = "C2NET";
force ghost_acre_WESTChannelName15 = "AIR2GND";
force ghost_acre_WESTChannelName16 = "MEDNET";
force ghost_acre_WESTChannelName2 = "DETNET_1";
force ghost_acre_WESTChannelName3 = "DETNET_1-1";
force ghost_acre_WESTChannelName4 = "DETNET_1-2";
force ghost_acre_WESTChannelName5 = "DETNET_2";
force ghost_acre_WESTChannelName6 = "DETNET_2-1";
force ghost_acre_WESTChannelName7 = "DETNET_2-2";
force ghost_acre_WESTChannelName8 = "DETNET_3";
force ghost_acre_WESTChannelName9 = "DETNET_3-1";

// Ghosts of Battle - AI Disembark
force ghost_ai_disembark_enabled = true;
force ghost_ai_disembark_stayInImmobileChance = 0.2927;

// Ghosts of Battle - Back To Game
force ghost_back_to_game_enableAddon = true;
force ghost_back_to_game_removeBody = true;
...
force ghost_fatigue_highJogCoefEnabled = true;

// Ghosts of Battle - Friendly Fire
force ghost_friendly_fire_loggingEnabled = true;

// Ghosts of Battle - FRIES
force ghost_fries_autoAdd = true;

// Ghosts of Battle - Grass
force ghost_grass_enabled = true;

// Ghosts of Battle - Insurgents
force ghost_insurgents_enabled_CUP = false;
force ghost_insurgents_enabled_Vanilla = true;

// Ghosts of Battle - Pointing
force ghost_pointing_vehicleEnabled = true;

// Ghosts of Battle - Remote Sensors
force ghost_remotesensors_enabled = true;

// Ghosts of Battle - Respawn
...
// Ghosts of Battle - Towing
force ghost_towing_addToCars = true;
force ghost_towing_addToHeavyDutyVehicles = true;

// GREEN EVO - Cut the grass
GREN_grass_cutter_active = false;

// GREN EVO - Bullet whistles
GREN_whistle_bullet = true;

// GREN EVO - Disable debug spawn modules
GREN_deactivate_debug_module_spawn = true;

// GREN EVO - Distractor-Stun-White weapon
GREN_distractor_active = false;
GREN_distractor_dist = 20;

// GREN EVO - Diving ADV
GREN_OXY_adv_active = true;
GREN_oxy_adv_active_time = 15;
GREN_oxy_adv_time_unconscious = 30;
GREN_OXY_diver_depth = true;
GREN_OXY_remaining_time = true;

// GREN EVO - Explosive vest
GREN_tnt_vest = false;

// GREN EVO - Hide-discover body
GREN_active_detect_body = true;
GREN_behavior_detect_body = 0;
GREN_detect_body_type = 1;
GREN_pos_body_dead = true;
GREN_pos_body_dead_ace = true;
GREN_radius_detect_body = 20;

// GREN EVO - Jump ADV
GREN_jump_adv_active = true;
GREN_jump_adv_active_time = 15;
GREN_jump_adv_alt_option = 0;
GREN_jump_adv_altitude = "4000";
GREN_jump_adv_mask = "GREN_Mat_oxy";
GREN_jump_adv_mask_option = 1;

// GREN EVO - Remove Map
GREN_deletemap = false;
...
GREN_suppress_level = 0;
GREN_suppress_main = "RECEIVE INFORMATION";
GREN_suppress_text1 = "no information";
GREN_suppress_text2 = "no information";
GREN_suppress_text3 = "no information";
GREN_suppress_text4 = "no information";
GREN_suppress_title = "Title";
GREN_suppress_voice = 0;
...
mts_markers_useVanillaColors = true;
...
zen_faction_filter_0_DSF_CHECH = true;
zen_faction_filter_0_DSF_HAMAS = true;
zen_faction_filter_0_DSF_IGF = true;
zen_faction_filter_0_DSF_IGF_groups = true;
zen_faction_filter_0_DSF_IRAN = true;
zen_faction_filter_0_DSF_LDPR = true;
zen_faction_filter_0_DSF_PMF = true;
zen_faction_filter_0_DSF_SAA = true;
zen_faction_filter_0_DSF_TAL = true;
zen_faction_filter_0_DSF_WAG = true;
...
zen_faction_filter_0_Theseus_OPF_B_F = true;
zen_faction_filter_0_Theseus_OPF_R_F = true;
...
zen_faction_filter_1_DSF_ANA = true;
zen_faction_filter_1_DSF_ANA_groups = true;
zen_faction_filter_1_DSF_CIA = true;
zen_faction_filter_1_DSF_COP = true;
zen_faction_filter_1_DSF_CORP = true;
zen_faction_filter_1_DSF_HTS = true;
zen_faction_filter_1_DSF_IDF = true;
zen_faction_filter_1_DSF_UAF = true;
zen_faction_filter_1_DSF_UKR = true;
zen_faction_filter_1_Theseus_BLU_N_D_F = true;
zen_faction_filter_1_Theseus_BLU_N_F = true;
...
zen_faction_filter_2_DSF_ISIS = true;
zen_faction_filter_2_DSF_MIL = true;
zen_faction_filter_2_DSF_USMILITIA = true;
...
zen_faction_filter_2_Theseus_IND_B_F = true;
zen_faction_filter_3_CIV_F = true;
zen_faction_filter_3_CIV_IDAP_F = true;
zen_faction_filter_3_DSF_Civilians = true;
