...
// cTab
force ctab_compass_enable = true;
...
force ctab_core_useArmaMarker = false;
...
// Ghosts of Battle - Chat
force ghost_chat_allowGlobalChat = true;
...
// NER Bulat V3
force NER_bulatV3_debugEnabled = false;
force NER_bulatV3_detectCivilian = true;
force NER_bulatV3_detectEast = true;
force NER_bulatV3_detectOnlySideAndClassComb = "";
force NER_bulatV3_detectResistance = true;
force NER_bulatV3_detectWest = true;
force NER_bulatV3_maxHearDistMeters = 10;
force NER_bulatV3_scanDistanceMeters = 1000;
...
force force sss_artillery_relocateCooldown = false;
...
force TFAR_globalRadioRangeCoef = 3;
...
force TFAR_setting_defaultFrequencies_sr_west = "100,101,102,103,104,105,200,300";
force TFAR_setting_defaultFrequencies_sr_east = "";
force TFAR_setting_defaultFrequencies_sr_independent = "";
force TFAR_setting_defaultFrequencies_lr_west = "310,320,330,340,350,360,370,380";
...
force tuncon_unconinfo_noFriendliesNearbyText = "Your current situation is not looking very good, you could wait or feel free to just press Esc -> Respawn.";
