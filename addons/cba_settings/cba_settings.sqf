...
force ghostfa_mediumcaliber_cuasCeiling = 1.4;
force ghostfa_mediumcaliber_enableAirburst = true;
force ghostfa_mediumcaliber_factionScaling = true;
force ghostfa_mediumcaliber_greenFraction = 0.85;
force ghostfa_mediumcaliber_redFraction = 0.75;

// [UM] ACE Medical Additions
force UM_autoTriage_mode = 2;
UM_blurStrength = 3;
UM_blurUnconScreen = true;
force UM_medNotif_clearActionEnabled = true;
UM_medNotif_colorMedic = [0.85,0.2,0.2,1];
UM_medNotif_colorNonMedic = [1,1,1,1];
UM_medNotif_cooldown = 10;
UM_medNotif_enabled = true;
UM_medNotif_finishedEnabled = true;
UM_medNotif_fontBody = "Purista";
UM_medNotif_fontName = "Purista";
UM_medNotif_iconMedic = "z\ace\addons\medical_gui\ui\cross_t_9.paa";
UM_medNotif_iconMedicCustom = false;
UM_medNotif_iconNonMedic = "x\zen\addons\context_actions\ui\medical_cross_ca.paa";
UM_medNotif_iconNonMedicCustom = false;
UM_medNotif_message = "%1 is treating you, kindly hold still.";
UM_medNotif_messageCleared = "%1 has cleared you, you are good to go.";
UM_medNotif_messageFinished = "%1 has finished a treatment on you.";
UM_medNotif_messageUncon = "%1 is still treating you, stay with us!";
UM_medNotif_unconEnabled = true;
UM_nearestMedic_enabled = true;
UM_unconBlackout_arrestDarkness = 1;
UM_unconBlackout_enabled = true;
UM_unconBlackout_lowHrThreshold = 30;
UM_unconBlackout_pulseGap = 6;
UM_unconIcon_arrestColor = [0.55,0,0,1];
UM_unconIcon_arrestColorEnabled = true;
UM_unconIcon_color = [1,1,1,1];
UM_unconIcon_customEnabled = false;
UM_unconIcon_customPath = "";
force UM_unconIcon_enabled = true;
force UM_unconIcon_maxRange = 100;
force UM_unconIcon_medicOnly = true;
force UM_unconIcon_minRange = 4;
UM_unconIcon_shadow = 1;
UM_unconIcon_size = 0.2;
force UM_unconSpectator = false;
force UM_unconSpectator_arrestOnly = false;
force UM_unconSpectator_cameraModes = 1;
UM_unconThirdPerson = false;
force UM_unconVoice_arrestMute = true;
force UM_unconVoice_mode = 0;
force UM_unconZeusExempt = true;
...
force ace_hitreactions_weaponDropChanceArmHitAI = 0.15;
...
// Action Menu
GW_setting_customConfig = "";
force GW_setting_noModuleBehavior = "default";
GW_setting_showNumberIndicators = false;
GW_setting_showSignalIcon = true;
GW_setting_signalDefaultRadius = 10;
GW_setting_signalDuration = 5;
GW_setting_signalVisibility = "group";
GW_setting_ySquash = 0.9;


// AI Helicopter Decelerate No Climbing
force force AHDNC_main_enabled_VTOL = true;
...
DT_focusedBoostEnabled = false;
DT_incrementValue = 500;
DT_notificationsEnabled = true;
DT_scopeBoostEnabled = false;
force DT_terrainGridMax = 50;
DT_viewDistanceEnabled = true;
DT_viewDistanceHotkey1 = 3000;
DT_viewDistanceHotkey2 = 6000;
...
// Fiber-Optic FPV
force force vnd_allowBotsShoot = true;
force force vnd_fiberTTL = 60;
vnd_showFiber = true;
vnd_showHorizon = true;

// FPV Settings
FPV_DefaultText = "CROCUS";
force FPV_isUavCaptive = true;
force FPV_MaxFlightDistance = 4000;
...
force force ghost_back_to_game_removeBody = true;
...
force force ghost_evac_medicOnly = true;
force force ghost_evac_time = 10;
...
force ghost_medical_treatment_fatalInjuriesCardiacArrestTimeCoefficient = 0.2;
force force ghost_pointing_vehicleEnabled = true;
force ghost_remotesensors_enabled = true;
...
force force ghost_spectator_allowUnconscious = true;
...
ghost_spectator_enabledUnconscious = true;
...
force ghost_suppress_overlayTexture = 1;
...
force Rev_tp_action_radius = 5;
force Rev_tp_action_time = 6;
force YMF_Settings_addEarplugs = true;
force YMF_Settings_allowInsigniaApplication = true;
force YMF_Settings_enableRadios = true;
force YMF_Settings_enableStagingSystem = true;
force YMF_Settings_enableVehicleInventory = true;
force YMF_Settings_enableVehiclePylon = true;
force YMF_Settings_enableVehicleRadios = true;
force YMF_Settings_enableVehicleSystem = true;
force force YMF_Settings_jumpSimulation = 2;
force force YMF_Settings_jumpSimulationGlasses = true;
force force YMF_Settings_jumpSimulationHat = true;
force force YMF_Settings_jumpSimulationNVG = true;
force YMF_Settings_patrolBaseEnabled = true;
force YMF_Settings_patrolBaseKitCount = 4;
force YMF_Settings_patrolBaseKitRange = 3;
force YMF_Settings_patrolBaseMaxCount = 3;
force YMF_Settings_patrolBaseZoneSize = 15;
force YMF_Settings_setAiSystemDifficulty = 2;
force YMF_Settings_setMissionType = 1;
force YMF_Settings_setPlayerRank = true;
force YMF_Settings_setRadio = true;
force YMF_Settings_showDiaryRecords = true;
force YMF_Settings_vehicleFactions = "[""BLU_W_F"",""BLU_T_F"",""BLU_NATO_lxWS"",""BLU_F"",""USAF"",""tweed_UA_21"",""ghost""]";

// Ghosts of Battle - Future Ammunition
force ghostfa_ammo_debugBreaching = false;
force force ghostfa_ammo_enableBreaching = true;

// Ghosts of Battle - Future Ammunition - Anti-Drone
force ghostfa_antidrone_damageMultiplier = 1;
force ghostfa_antidrone_lethalRadiusMultiplier = 1;
force ghostfa_antidrone_triggerRadiusMultiplier = 1;

// Ghosts of Battle - nvg
force ghost_nvg_ACE = false;
force force ghost_nvg_Blacklist = "";
force ghost_nvg_Effect = "";
...
force GX_DRONES_COMMAND_INTERACTION_ENABLE = false;
force GX_DRONES_COMMAND_NON_CONNECTED_ENABLE = true;
force GX_DRONES_TIME_TO_DEPLOY = 3;
force GX_DRONES_TIME_TO_PICKUP = 3;
force GX_DRONES_TIME_TO_REARM = 2;
force GX_DRONES_TIME_TO_RECHARGE = 2;
...
force force sss_optionadminAccess = true;
