...
// GHOST - adminMenu
ghost_adminMenu_endLogToRPT = false;
ghost_adminMenu_printToChat = 1;
...
force ghost_spectator_enabled = false;
force ghost_spectator_freeCamera = false;
force ghost_spectator_freeCameraUnconscious = false;
force ghost_spectator_sides = 0;
force ghost_spectator_sidesUnconscious = 0;
