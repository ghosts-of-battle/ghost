...
// set up uiNamespace
uiNamespace setVariable ["GHOST_CC_currentRadioObject", _radio];
...
_buttonOK ctrlSetEventHandler ["ButtonClick", format["[] call ghost_commandcenter_fnc_handleRadioConfig"]];
