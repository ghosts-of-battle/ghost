...
// set the mode
_object setVariable [format ["GHOST_CC_screen_%1_mode", _selection], "DCAM", true];
...
[_object, _selection, _rendertarget, _data, _seat] remoteExec ["ghost_commandcenter_fnc_viewDCamGlobal", 0, _screen_JIP_ID];
