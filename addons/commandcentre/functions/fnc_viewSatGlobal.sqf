...
} forEach (cTabHcamlist + GHOST_CC_vehicleCamList);
...
[_object, _selection] call ghost_commandcenter_fnc_deleteCamera;
...
_object setVariable [format ["GHOST_CC_screen_%1_Cam", _selection], [_cam, objNull, _host]];