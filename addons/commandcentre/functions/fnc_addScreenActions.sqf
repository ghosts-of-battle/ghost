...
private _configAction = [
	...
	},
	{
		...
		_object getVariable [format ["GHOST_CC_screen_%1_on", _selection], false];
	},
	nil,
...
private _turnOnAction = [
	...
	"",
	{
		...
		[_object, _selection, true, _args] call ghost_commandcenter_fnc_turnOnScreen;
	},
	{
		params ["_target", "_player", "_params"];
		_params params ["_object", "_selection"];
...
private _turnOffAction = [
	...
	"",
	{
		...
		[_object, _selection, false, _args] call ghost_commandcenter_fnc_turnOnScreen;
	},
	{
		params ["_target", "_player", "_params"];
		_params params ["_object", "_selection"];
...
private _toggleVisualAction = [
	...
	"",
	{
		...
		[_object, _selection] call ghost_commandcenter_fnc_toggleVisualMode;
	},
	{
		params ["_target", "_player", "_params"];
		_params params ["_object", "_selection"];
