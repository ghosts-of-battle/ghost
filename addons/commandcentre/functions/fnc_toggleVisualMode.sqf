...
private _currentVM = _object getVariable [format ["GHOST_CC_screen_%1_visionMode", _selection], 0];
...
_object setVariable [format ["GHOST_CC_screen_%1_visionMode", _selection], _nextVM, true];