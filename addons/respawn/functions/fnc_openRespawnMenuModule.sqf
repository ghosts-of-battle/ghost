 ...
 *
 * Example:
 * [logicObj] call ghost_respawn_fnc_openRespawnMenuModule;
 *
 * Public: No
 */
...
if !(EGVAR(spectate,enabled)) exitWith { WARNING("Open respawn menu called, without ghost spectator being enabled"); };
