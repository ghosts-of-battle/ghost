 ...
 *
 * Example:
 * [ghost_aiVehicleBail_fnc_handleTankDamage, tank1, "Hit_Engine", 12]] call CBA_fnc_execNextFrame
 *
 *
 * Public: No
 */
...
if (_ignoreHit) exitWith {
    diag_log text format["[GHOST] Ignoring multiple hits done to vehicle [%1] by [%2].", _vehicle, _injurer];
};
