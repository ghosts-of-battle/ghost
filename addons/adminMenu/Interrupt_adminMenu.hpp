...
class GHOST_EscapeButton_Base1: RscShortcutButton {
    class ShortcutPos {
        left = 0;
        top = 0;
        w = 0;
...
class GHOST_EscapeButton_Base2: RscShortcutButton {
    class ShortcutPos {
        left = 0;
        top = 0;
        w = 0;
...
class RscDisplayMPInterrupt: RscStandardDisplay {
    class controls {
        class GHOST_EscapeButton1: GHOST_EscapeButton_Base1{};
        class GHOST_EscapeButton2: GHOST_EscapeButton_Base2{};
    };
};
...
class GVAR(adminMenuDialog) {
    ...
    class controlsBackground {
        ...
        class RscText_1000: RscText {
            idc = -1;
            style = 2;
            text = "GHOST (from BourbonWarfare)"; //--- ToDo: Localize;
            x = QUOTE(0.2 * safezoneW + safezoneX);
