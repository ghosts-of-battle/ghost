 ...
 * target building near a player inside this module's TAOR and fires a mission on it.
 *
 * State lives on the logic, so several batteries run independently.
 *
...
[_tgt, _cfg get "rounds", _cfg get "spread", _cfg get "shell"] call FUNC(fireMission);
