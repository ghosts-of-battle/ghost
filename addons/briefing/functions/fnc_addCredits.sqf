 ...
 *
 * Examples:
 * [player] call ghost_briefing_fnc_addCredits;
 *
 * Public: Yes
 */
...
private _ghostVersion = getText (configFile >> "CfgPatches" >> "ghost_core" >> "versionStr");
...
BWMF Version: %4<br/>
GHOST Version: %5
", _missionName, _authorName, _worldName, _missionFrameworkDate, _ghostVersion
