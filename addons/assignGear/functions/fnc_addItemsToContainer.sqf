 ...
 *
 * Example:
 * [_configItems, _containersArray, UNIFORM_INDEX] call ghost_assignGear_addItemsToContainer;
 *
 * Public: No
 */
...
private _returnArray = [];
{
    ...
    private _itemLeft = [] call {
        ...
        if (_mass < 0) exitWith {
            diag_log text format ["[GHOST-assignGear] Item Not Found [%1]", _itemToAdd];
