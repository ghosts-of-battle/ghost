 ...
 *
 * Example:
 * [missionConfigFile >> "CfgLoadouts" >> (faction player) >> (typeOf player), player] call ghost_assignGear_fnc_getLoadoutFromConfig
 * [missionConfigFile >> "CfgLoadouts" >> "ghost_w" >> "rifleman", objNull] call ghost_assignGear_fnc_getLoadoutFromConfig
 *
 * Public: No
 */
