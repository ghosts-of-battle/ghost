 ...
 *
 * Example:
 * [_linkedItem, _binocularArray, _configMagazines] call ghost_assignGear_fnc_getLinkedIndex;
 *
 * Public: No
 */
...
diag_log text format ["[GHOST-assignGear] - linkedItems [%1] unknown type", _linkedItem];
UNK_INDEX
