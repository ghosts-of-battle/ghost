class CfgVehicles {
    ...
    class GVAR(east_rifleman): GVAR(base_prebuilt) {
        ...
        category = QGVAR(east);
        GVAR(crewAir) = "ghost_e_pilot";
        GVAR(crewArmor)= "ghost_e_vicc";
        GVAR(createUnits)[] = {"ghost_e_rifleman"};
    };
    class GVAR(east_ftl): GVAR(east_rifleman) {
        displayName = "@FTL";
        GVAR(createUnits)[] = {"ghost_e_ftl"};
    };
    class GVAR(east_ar): GVAR(east_rifleman) {
        displayName = "@AR";
        GVAR(createUnits)[] = {"ghost_e_AR"};
    };
    class GVAR(east_rat): GVAR(east_rifleman) {
        displayName = "@RAT";
        GVAR(createUnits)[] = {"ghost_e_LAT"};
    };
    class GVAR(east_manpad): GVAR(east_rifleman) {
        displayName = "@MANPAD";
        GVAR(createUnits)[] = {"ghost_e_msamg"};
    };
    class GVAR(east_manpadTeam): GVAR(east_rifleman) {
        ...
        GVAR(createUnits)[] = {"ghost_e_msamg","ghost_e_msamag"};
    };
    class GVAR(east_matTeam): GVAR(east_rifleman) {
        displayName = "#MAT Team (2)";
        icon = "\a3\Ui_F_Curator\Data\Displays\RscDisplayCurator\modeGroups_ca.paa";
        GVAR(createUnits)[] = {"ghost_e_matg","ghost_e_matag"};
    };
    class GVAR(east_patrol): GVAR(east_rifleman) {
        displayName = "#Patrol (2)";
        icon = "\a3\Ui_F_Curator\Data\Displays\RscDisplayCurator\modeGroups_ca.paa";
        GVAR(createUnits)[] = {"ghost_e_rifleman","ghost_e_rifleman"};
    };
    class GVAR(east_fireteam): GVAR(east_rifleman) {
        displayName = "#Fireteam (4)";
        icon = "\a3\Ui_F_Curator\Data\Displays\RscDisplayCurator\modeGroups_ca.paa";
        GVAR(createUnits)[] = {"ghost_e_ftl","ghost_e_AR","ghost_e_rifleman","ghost_e_LAT"};
    };
    class GVAR(east_squad): GVAR(east_rifleman) {
        displayName = "#Squad (8)";
        icon = "\a3\Ui_F_Curator\Data\Displays\RscDisplayCurator\modeGroups_ca.paa";
        GVAR(createUnits)[] = {"ghost_e_sl","ghost_e_ftl","ghost_e_ar","ghost_e_ar","ghost_e_lat","ghost_e_rifleman","ghost_e_rifleman","ghost_e_rifleman"};
    };
    ...
    class GVAR(east_dismounts): GVAR(east_rifleman) {
        ...
        GVAR(createUnits)[] = {"ghost_e_sl","ghost_e_ar","ghost_e_lat","ghost_e_rifleman","ghost_e_rifleman","ghost_e_rifleman"};
    };
    ...
    class GVAR(west_rifleman): GVAR(base_prebuilt) {
        ...
        displayName = "@Rifleman";
        category = QGVAR(west);
        GVAR(crewAir) = "ghost_w_pilot";
        GVAR(crewArmor)= "ghost_w_vicc";
        GVAR(createUnits)[] = {"ghost_w_rifleman"};
    };
    class GVAR(west_ftl): GVAR(west_rifleman) {
        displayName = "@FTL";
        GVAR(createUnits)[] = {"ghost_w_ftl"};
    };
    class GVAR(west_ar): GVAR(west_rifleman) {
        displayName = "@AR";
        GVAR(createUnits)[] = {"ghost_w_ar"};
    };
    class GVAR(west_rat): GVAR(west_rifleman) {
        displayName = "@RAT";
        GVAR(createUnits)[] = {"ghost_w_lat"};
    };
    class GVAR(west_manpad): GVAR(west_rifleman) {
        displayName = "@MANPAD";
        GVAR(createUnits)[] = {"ghost_w_msamg"};
    };
    class GVAR(west_manpadTeam): GVAR(west_rifleman) {
        displayName = "#MANPAD Team (2)";
        icon = "\a3\Ui_F_Curator\Data\Displays\RscDisplayCurator\modeGroups_ca.paa";
        GVAR(createUnits)[] = {"ghost_w_msamg","ghost_w_msamag"};
    };
    class GVAR(west_matTeam): GVAR(west_rifleman) {
        displayName = "#MAT Team (2)";
        icon = "\a3\Ui_F_Curator\Data\Displays\RscDisplayCurator\modeGroups_ca.paa";
        GVAR(createUnits)[] = {"ghost_w_matg","ghost_w_matag"};
    };
    class GVAR(west_patrol): GVAR(west_rifleman) {
        displayName = "#Patrol (2)";
        icon = "\a3\Ui_F_Curator\Data\Displays\RscDisplayCurator\modeGroups_ca.paa";
        GVAR(createUnits)[] = {"ghost_w_rifleman","ghost_w_rifleman"};
    };
    class GVAR(west_fireteam): GVAR(west_rifleman) {
        displayName = "#Fireteam (4)";
        icon = "\a3\Ui_F_Curator\Data\Displays\RscDisplayCurator\modeGroups_ca.paa";
        GVAR(createUnits)[] = {"ghost_w_ftl","ghost_w_ar","ghost_w_rifleman","ghost_w_lat"};
    };
    class GVAR(west_squad): GVAR(west_rifleman) {
        displayName = "#Squad (8)";
        icon = "\a3\Ui_F_Curator\Data\Displays\RscDisplayCurator\modeGroups_ca.paa";
        GVAR(createUnits)[] = {"ghost_w_sl","ghost_w_ftl","ghost_w_ar","ghost_w_ar","ghost_w_lat","ghost_w_rifleman","ghost_w_rifleman","ghost_w_rifleman"};
    };
    ...
    class GVAR(west_dismounts): GVAR(west_rifleman) {
        ...
        displayName = "#Dismounts (6) [attach]";
        portrait = "\A3\Air_F_Beta\Parachute_01\Data\UI\Portrait_Parachute_01_CA.paa";
        GVAR(createUnits)[] = {"ghost_w_sl","ghost_w_ar","ghost_w_lat","ghost_w_rifleman","ghost_w_rifleman","ghost_w_rifleman"};
    };
    ...
    class GVAR(ind_rifleman): GVAR(base_prebuilt) {
        ...
        displayName = "@Rifleman";
        category = QGVAR(ind);
        GVAR(crewAir) = "ghost_i_pilot";
        GVAR(crewArmor)= "ghost_i_vicc";
        GVAR(createUnits)[] = {"ghost_i_rifleman"};
    };
    class GVAR(ind_ftl): GVAR(ind_rifleman) {
        displayName = "@FTL";
        GVAR(createUnits)[] = {"ghost_i_ftl"};
    };
    class GVAR(ind_ar): GVAR(ind_rifleman) {
        displayName = "@AR";
        GVAR(createUnits)[] = {"ghost_i_ar"};
    };
    class GVAR(ind_rat): GVAR(ind_rifleman) {
        displayName = "@RAT";
        GVAR(createUnits)[] = {"ghost_i_lat"};
    };
    class GVAR(ind_manpad): GVAR(ind_rifleman) {
        displayName = "@MANPAD";
        GVAR(createUnits)[] = {"ghost_i_msamg"};
    };
    class GVAR(ind_manpadTeam): GVAR(ind_rifleman) {
        displayName = "#MANPAD Team (2)";
        icon = "\a3\Ui_F_Curator\Data\Displays\RscDisplayCurator\modeGroups_ca.paa";
        GVAR(createUnits)[] = {"ghost_i_msamg","ghost_i_msamag"};
    };
    class GVAR(ind_matTeam): GVAR(ind_rifleman) {
        displayName = "#MAT Team (2)";
        icon = "\a3\Ui_F_Curator\Data\Displays\RscDisplayCurator\modeGroups_ca.paa";
        GVAR(createUnits)[] = {"ghost_i_matg","ghost_i_matag"};
    };
    class GVAR(ind_patrol): GVAR(ind_rifleman) {
        displayName = "#Patrol (2)";
        icon = "\a3\Ui_F_Curator\Data\Displays\RscDisplayCurator\modeGroups_ca.paa";
        GVAR(createUnits)[] = {"ghost_i_rifleman","ghost_i_rifleman"};
    };
    class GVAR(ind_fireteam): GVAR(ind_rifleman) {
        displayName = "#Fireteam (4)";
        icon = "\a3\Ui_F_Curator\Data\Displays\RscDisplayCurator\modeGroups_ca.paa";
        GVAR(createUnits)[] = {"ghost_i_ftl","ghost_i_ar","ghost_i_rifleman","ghost_i_lat"};
    };
    class GVAR(ind_squad): GVAR(ind_rifleman) {
        displayName = "#Squad (8)";
        icon = "\a3\Ui_F_Curator\Data\Displays\RscDisplayCurator\modeGroups_ca.paa";
        GVAR(createUnits)[] = {"ghost_i_sl","ghost_i_ftl","ghost_i_ar","ghost_i_ar","ghost_i_lat","ghost_i_rifleman","ghost_i_rifleman","ghost_i_rifleman"};
    };
    ...
    class GVAR(ind_dismounts): GVAR(ind_rifleman) {
        ...
        displayName = "#Dismounts (6) [attach]";
        portrait = "\A3\Air_F_Beta\Parachute_01\Data\UI\Portrait_Parachute_01_CA.paa";
        GVAR(createUnits)[] = {"ghost_i_sl","ghost_i_ar","ghost_i_lat","ghost_i_rifleman","ghost_i_rifleman","ghost_i_rifleman"};
    };
    ...
    class GVAR(garrison): GVAR(build_a_group) { //TODO: refactor this to be a lot more dynamic
        ...
        class Attributes {
            class GVAR(garrisonFaction) {
                ...
                class values {
                    class 1 { name = "NATO"; value = "ghost_w"; default = 1; };
                    class 2 { name = "AAF"; value = "ghost_i"; };
                    class 3 { name = "CSAT"; value = "ghost_e"; };
                };
