 ...
 *
 * Examples:
 * ["You're a zeus, congratulations"] call ghost_zeusHC_fnc_sendCuratorHint
 * ["You're specifically a zeus, congratulations", objZeusMan] call ghost_zeusHC_fnc_sendCuratorHint
 *
 * Public: Yes
 */
...
diag_log text format ["[GHOST] - %1, sent to: %2", _message, _curators];
