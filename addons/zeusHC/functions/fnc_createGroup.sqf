 ...
 *
 * Examples:
 * [west, position player, ["SoldierWB"]] call ghost_zeusHC_fnc_createGroup;
 * [east, [1,2,3], ["SoldierWB","SoldierWB"], "FORM", "_this setPos [4,5,6];"] call ghost_zeusHC_fnc_createGroup;
 *
 * Public: Yes
 */
