 ...
 *
 * Examples:
 * ["test hint", "hint"] call ghost_zeusHC_fnc_hcPassthrough;
 * [[], "ghost_zeusHC_fnc_buildACache"] call ghost_zeusHC_fnc_hcPassthrough;
 * [[], "ghost_zeusHC_fnc_buildACache",true] call ghost_zeusHC_fnc_hcPassthrough;
 *
 * Public: Yes
 */
