 ...
 *
 * Examples:
 * [(findDisplay 12) displayCtrl 52] call ghost_markers_fnc_drawMarkers; // draw markers on map
 * [(findDisplay 133) displayCtrl 101] call ghost_markers_fnc_drawMarkers; // draw markers on GPS
 *
 * Public: No
 */
