 ...
 *
 * Examples:
 * [(findDisplay 12), 52] call ghost_markers_fnc_addMarkersToDisplay; // add markers to main map
 * [(findDisplay 133), 101] call ghost_markers_fnc_addMarkersToDisplay; // add markers to GPS
 *
 * Public: No
 */
