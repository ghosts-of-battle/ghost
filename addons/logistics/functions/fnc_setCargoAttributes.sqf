 ...
 *
 * Example:
 * [myTruck] call ghost_logistics_fnc_setCargoAttributes;
 * [myTruck, 30, -1] call ghost_logistics_fnc_setCargoAttributes;
 * [myCrate, -1, 2] call ghost_logistics_fnc_setCargoAttributes;
 * [myCrate, -1, 2, true, false] call ghost_logistics_fnc_setCargoAttributes;
 * [myCrate, nil, nil, true, false] call ghost_logistics_fnc_setCargoAttributes;
 *
 * Public: Yes
 */
