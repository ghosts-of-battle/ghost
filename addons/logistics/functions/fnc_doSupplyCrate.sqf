 ...
 *
 * Example:
 * [[0.0,0.0,0.0],"crate_resupply_general"] call ghost_logistics_fnc_doSupplyCrate;
 * [[0.0,0.0,0.0],"crate_medical"] call ghost_logistics_fnc_doSupplyCrate;
 */
...
switch (_crateType) do {
    ...
    case "crate_resupply_general": {
        _crateModel = "ghost_equipment_outlawHQ";
    };
    case "crate_reaper";
    case "crate_nomad";
    case "crate_talon": {
    ...
    case "crate_titan": {
        _crateModel = "ghost_equipment_AA";
    };
    case "crate_nlaw";
    case "crate_spike";
    case "crate_maaws": {
    ...
    case "crate_javelin": {
        _crateModel = "ghost_equipment_javlen";
    };
    case "crate_eng": {
        _crateModel = "ghost_equipment_eng";
    };
    case "crate_m2": {
        _crateModel = "ghost_equipment_50cal";
    };
    case "crate_mo": {
