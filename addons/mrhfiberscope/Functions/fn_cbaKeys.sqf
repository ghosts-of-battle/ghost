...
_statementTurnLeft =
	{_cam = player getVariable "GHOST_FiberScopeCam"; 
...
_statementToggleNvgs =
	...
	if (isNil "_cam") ExitWith {};
	if (isNull _cam) exitWith {};
	_toggleStatus = player getVariable "GHOST_FiberScopeCamNVGs";
	...
	playsound "MRH_NV";								
	player setVariable ["GHOST_FiberScopeCamNVGs", _toggleStatus];
	};
