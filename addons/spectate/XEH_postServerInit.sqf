...
if (GVAR(enabled)) then {
    ...
    [
        ...
        },
        {
            ...
            diag_log format ["[GHOST-spectate] Spectate group: %1, spectate unit: %2", GVAR(group), GVAR(holderUnit)];
        },
        diag_tickTime + 5
    ...
    [{
        ["ghost_adminMsg", ["Warning: Spectate/Respawn Disabled (This should never happen on a BWMF mission)", "Server"]] call CBA_fnc_globalEvent;
