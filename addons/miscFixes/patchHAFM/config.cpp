...
class CfgPatches {
    class ADDON {
        ...
        requiredAddons[] = { "ghost_core", "HAFM_Army_Units2","HAFM_Air_Configs","HAFM_ArmA2_Helis","HAFM_Kiowa_Config","HAFM_NH90_Config","HAFM_ArmA2","HAFM_Vehicles_Configs","HAFM_Naval" };
