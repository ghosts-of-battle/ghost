class CfgVehicles {
    ...
    class GVAR(Item_H_Helmet_FASTMT_Cover_ghost_US_OCP_F): Item_Base_F {
        author = QAUTHOR;
        scope = 2;
        scopeCurator = 2;
    ...
    class GVAR(Item_H_Booniehat_Multicam_F): Item_Base_F {
        ...
        scope = 2;
        scopeCurator = 2;
        displayName = "[Ghost] Booniehat (Multicam)";
        editorCategory = "EdCat_Equipment";
        editorSubcategory = "EdSubcat_Headgear";
        vehicleClass = "ItemsHeadgear";
        model = "\A3\Weapons_F\dummyweapon.p3d";
    ...
    class GVAR(Item_H_Booniehat_Multicam_hs_F): Item_Base_F {
        ...
        scope = 2;
        scopeCurator = 2;
        displayName = "[Ghost] Booniehat (Multicam) [Headset]";
        editorCategory = "EdCat_Equipment";
        editorSubcategory = "EdSubcat_Headgear";
        vehicleClass = "ItemsHeadgear";
        model = "\A3\Weapons_F\dummyweapon.p3d";
    ...
    class GVAR(Item_H_Booniehat_Multicam_Snow_F): Item_Base_F {
        ...
        scope = 2;
        scopeCurator = 2;
        displayName = "[Ghost] Booniehat (Multicam Snow)";
        editorCategory = "EdCat_Equipment";
        editorSubcategory = "EdSubcat_Headgear";
        vehicleClass = "ItemsHeadgear";
        model = "\A3\Weapons_F\dummyweapon.p3d";
    ...
    class GVAR(Item_H_Booniehat_Multicam_Snow_hs_F): Item_Base_F {
        ...
        scope = 2;
        scopeCurator = 2;
        displayName = "[Ghost] Booniehat (Multicam Snow) [Headset]";
        editorCategory = "EdCat_Equipment";
        editorSubcategory = "EdSubcat_Headgear";
        vehicleClass = "ItemsHeadgear";
        model = "\A3\Weapons_F\dummyweapon.p3d";
    ...
    class GVAR(Item_H_Booniehat_Multicam_Woodland_F): Item_Base_F {
        ...
        scope = 2;
        scopeCurator = 2;
        displayName = "[Ghost] Booniehat (Multicam Woodland)";
        editorCategory = "EdCat_Equipment";
        editorSubcategory = "EdSubcat_Headgear";
        vehicleClass = "ItemsHeadgear";
        model = "\A3\Weapons_F\dummyweapon.p3d";
    ...
    class GVAR(Item_H_Booniehat_Multicam_Woodland_hs_F): Item_Base_F {
        ...
        scope = 2;
        scopeCurator = 2;
        displayName = "[Ghost] Booniehat (Multicam Woodland) [Headset]";
        editorCategory = "EdCat_Equipment";
        editorSubcategory = "EdSubcat_Headgear";
        vehicleClass = "ItemsHeadgear";
        model = "\A3\Weapons_F\dummyweapon.p3d";
    ...
    class GVAR(Item_H_Booniehat_Solid_CoyoteBrown_F): Item_Base_F {
        ...
        scope = 2;
        scopeCurator = 2;
        displayName = "[Ghost] Booniehat (Coyote)";
        editorCategory = "EdCat_Equipment";
        editorSubcategory = "EdSubcat_Headgear";
        vehicleClass = "ItemsHeadgear";
        model = "\A3\Weapons_F\dummyweapon.p3d";
    ...
    class GVAR(Item_H_Booniehat_Solid_CoyoteBrown_hs_F): Item_Base_F {
        ...
        scope = 2;
        scopeCurator = 2;
        displayName = "[Ghost] Booniehat (Coyote) [Headset]";
        editorCategory = "EdCat_Equipment";
        editorSubcategory = "EdSubcat_Headgear";
        vehicleClass = "ItemsHeadgear";
        model = "\A3\Weapons_F\dummyweapon.p3d";
    ...
    class GVAR(Item_H_Booniehat_Solid_Ranger_Green_F): Item_Base_F {
        ...
        scope = 2;
        scopeCurator = 2;
        displayName = "[Ghost] Booniehat (Ranger Green)";
        editorCategory = "EdCat_Equipment";
        editorSubcategory = "EdSubcat_Headgear";
        vehicleClass = "ItemsHeadgear";
        model = "\A3\Weapons_F\dummyweapon.p3d";
    ...
    class GVAR(Item_H_Booniehat_Solid_Ranger_Green_hs_F): Item_Base_F {
        ...
        scope = 2;
        scopeCurator = 2;
        displayName = "[Ghost] Booniehat (Ranger Green) [Headset]";
        editorCategory = "EdCat_Equipment";
        editorSubcategory = "EdSubcat_Headgear";
        vehicleClass = "ItemsHeadgear";
        model = "\A3\Weapons_F\dummyweapon.p3d";
    ...
    class GVAR(Item_H_Booniehat_Solid_Olive_F): Item_Base_F {
        ...
        scope = 2;
        scopeCurator = 2;
        displayName = "[Ghost] Booniehat (Olive)";
        editorCategory = "EdCat_Equipment";
        editorSubcategory = "EdSubcat_Headgear";
        vehicleClass = "ItemsHeadgear";
        model = "\A3\Weapons_F\dummyweapon.p3d";
    ...
    class GVAR(Item_H_Booniehat_Solid_Olive_hs_F): Item_Base_F {
        ...
        scope = 2;
        scopeCurator = 2;
        displayName = "[Ghost] Booniehat (Olive) [Headset]";
        editorCategory = "EdCat_Equipment";
        editorSubcategory = "EdSubcat_Headgear";
        vehicleClass = "ItemsHeadgear";
        model = "\A3\Weapons_F\dummyweapon.p3d";
    ...
    class GVAR(Item_H_Booniehat_Solid_Tan_F): Item_Base_F {
        ...
        scope = 2;
        scopeCurator = 2;
        displayName = "[Ghost] Booniehat (Tan)";
        editorCategory = "EdCat_Equipment";
        editorSubcategory = "EdSubcat_Headgear";
        vehicleClass = "ItemsHeadgear";
        model = "\A3\Weapons_F\dummyweapon.p3d";
    ...
    class GVAR(Item_H_Booniehat_Solid_Tan_hs_F): Item_Base_F {
        ...
        scope = 2;
        scopeCurator = 2;
        displayName = "[Ghost] Booniehat (Tan) [Headset]";
        editorCategory = "EdCat_Equipment";
        editorSubcategory = "EdSubcat_Headgear";
        vehicleClass = "ItemsHeadgear";
        model = "\A3\Weapons_F\dummyweapon.p3d";
    ...
    class GVAR(Item_H_Booniehat_Solid_White_F): Item_Base_F {
        ...
        scope = 2;
        scopeCurator = 2;
        displayName = "[Ghost] Booniehat (White)";
        editorCategory = "EdCat_Equipment";
        editorSubcategory = "EdSubcat_Headgear";
        vehicleClass = "ItemsHeadgear";
        model = "\A3\Weapons_F\dummyweapon.p3d";
    ...
    class GVAR(Item_H_Booniehat_Solid_White_hs_F): Item_Base_F {
        ...
        scope = 2;
        scopeCurator = 2;
        displayName = "[Ghost] Booniehat (White) [Headset]";
        editorCategory = "EdCat_Equipment";
        editorSubcategory = "EdSubcat_Headgear";
        vehicleClass = "ItemsHeadgear";
        model = "\A3\Weapons_F\dummyweapon.p3d";
