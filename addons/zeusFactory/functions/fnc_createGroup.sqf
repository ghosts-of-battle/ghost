...
switch (_side) do {
    case (west): {_soldierList = _soldierList apply {"ghost_w_"+_x};};
    case (east): {_soldierList = _soldierList apply {"ghost_e_"+_x};};
    case (resistance): {_soldierList = _soldierList apply {"ghost_i_"+_x};};
};
