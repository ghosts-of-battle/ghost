    ...
    class DOUBLES(PREFIX,FACTION_LETTER) {\
        ...
        class Infantry {\
            ...
            class CLASS_MACRO(fireteam_full) {\
                ...
                icon = "\z\ghost\addons\markers\data\infantry.paa";\
                class Unit0 {\
                    position[] = {0,0,0};\
                    rank = "CORPORAL";\
                    side = SIDE_NUM;\
        ...
        class Crew {\
            ...
            class CLASS_MACRO(armor_crew) {\
                name = "Armored Crew";\
                icon = "\z\ghost\addons\markers\data\armor.paa";\
                side = SIDE_NUM;\
                faction = QUOTE(DOUBLES(PREFIX,FACTION_LETTER));\
                class Unit0 {\
                    position[] = {0,0,0};\
            ...
            class CLASS_MACRO(air_crew):CLASS_MACRO(armor_crew) {\
                name = "Air Crew";\
                icon = "\z\ghost\addons\markers\data\helicopter.paa";\
                class Unit0 {\
                    position[] = {0,0,0};\
                    rank = "CAPTAIN";\
                    side = SIDE_NUM;\
        ...
        class Weapons {\
            ...
            class CLASS_MACRO(mmg) {\
                name = "MMG";\
                icon = "\z\ghost\addons\markers\data\mmg.paa";\
                side = SIDE_NUM;\
                faction = QUOTE(DOUBLES(PREFIX,FACTION_LETTER));\
                class Unit0 {\
                    position[] = {0,0,0};\
            ...
            class CLASS_MACRO(mat):CLASS_MACRO(mmg) {\
                name = "MAT";\
                icon = "\z\ghost\addons\markers\data\mat.paa";\
                class Unit0 {\
                    position[] = {0,0,0};\
                    rank = "SERGEANT";\
                    side = SIDE_NUM;\
            ...
            class CLASS_MACRO(msam):CLASS_MACRO(mat) {\
                name = "MSAM";\
                icon = "\z\ghost\addons\markers\data\msam.paa";\
                class Unit0 {\
                    position[] = {0,0,0};\
                    rank = "SERGEANT";\
                    side = SIDE_NUM;\
            ...
            class CLASS_MACRO(st) {\
                name = "Sniper Team";\
                icon = "\z\ghost\addons\markers\data\recon.paa";\
                side = SIDE_NUM;\
                faction = QUOTE(DOUBLES(PREFIX,FACTION_LETTER));\
                class Unit0 {\
                    position[] = {0,0,0};\
