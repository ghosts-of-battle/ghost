class CfgWeapons {
    ...
    class GVAR(V_CarrierSpec_US_OCP): V_PlateCarrierSpec_blk {
        author = QAUTHOR;
        displayName = "[Ghost] (US OCP) Carrier Special Rig";
        hiddenSelectionsTextures[] = {
            QPATHTOF(data\carrier_gl_rig_US_OCP.paa)
        };
        picture = QPATHTOF(data\ui\icon_carrier_spec_rig_US_OCP.paa);
        MACRO_ITEM_COMMON
        hiddenSelections[] = {
            "camo"
        };
    ...
    class GVAR(V_CarrierGL_US_OCP): V_PlateCarrierGL_blk {
        author = QAUTHOR;
        displayName = "[Ghost] (US OCP) Carrier GL Rig";
        hiddenSelectionsTextures[] = {
            QPATHTOF(data\carrier_gl_rig_US_OCP.paa)
        };
        picture = QPATHTOF(data\ui\icon_carrier_gl_rig_US_OCP.paa);
        MACRO_ITEM_COMMON
        hiddenSelections[] = {
            "camo"
        };
    ...
    class GVAR(V_CarrierLite_US_OCP): V_PlateCarrier1_blk {
        author = QAUTHOR;
        displayName = "[Ghost] (US OCP) Carrier Lite";
        hiddenSelectionsTextures[] = {
            QPATHTOF(data\vests_US_OCP_co.paa)
        };
        picture = QPATHTOF(data\ui\icon_V_plate_carrier_1_US_OCP_CA.paa);
        MACRO_ITEM_COMMON
        hiddenSelections[] = {
            "camo"
        };
    ...
    class GVAR(V_CarrierRig_US_OCP): V_PlateCarrier2_blk {
        author = QAUTHOR;
        displayName = "[Ghost] (US OCP) Carrier Rig";
        hiddenSelectionsTextures[] = {
            QPATHTOF(data\vests_US_OCP_co.paa)
        };
        picture = QPATHTOF(data\ui\icon_V_plate_carrier_2_US_OCP_CA.paa);
        MACRO_ITEM_COMMON
        hiddenSelections[] = {
            "camo"
        };
    ...
    class GVAR(V_CarrierLiteNoBelt_US_OCP): V_PlateCarrier_Kerry {
        author = QAUTHOR;
    ...
    class GVAR(V_Rangemaster_US_OCP): V_Rangemaster_belt {
        author = QAUTHOR;
        displayName = "[Ghost] (US OCP) Rangemaster Belt";
        hiddenSelectionsTextures[] = {
            QPATHTOF(data\vests_US_OCP_co.paa)
        };
        picture = QPATHTOF(data\ui\icon_V_Rangemaster_belt_US_OCP_ca.paa);
        MACRO_ITEM_COMMON
    };

    class GVAR(V_ChestRig_US_OCP): V_Chestrig_oli {
        author = QAUTHOR;
        displayName = "[Ghost] (US OCP) Chest Rig";
        hiddenSelectionsTextures[] = {
            QPATHTOF(data\equip_chestrig_US_OCP.paa),
            QPATHTOF(data\vests_US_OCP_co.paa)
        };
        picture = QPATHTOF(data\ui\icon_V_ChestrigF_US_OCP_ca.paa);
        MACRO_ITEM_COMMON
    };
    ...
    class GVAR(V_JCACompact_US_OCP): JCA_V_CarrierRigKBT_01_compact_olive_F {
        author = QAUTHOR;
        displayName = "[Ghost] (US OCP) Modular Carrier JCA Compact";
        hiddenSelectionsTextures[] = {
            QPATHTOF(data\CarrierRigKBT_01_US_OCP_CO.paa),
            "",
            ""
        };
        picture = QPATHTOF(data\ui\Icon_CarrierRigKBT_01_compact_US_OCP_F_CA.paa);
        MACRO_ITEM_COMMON
    };

    class GVAR(V_JCACQB_US_OCP): JCA_V_CarrierRigKBT_01_CQB_olive_F {
        author = QAUTHOR;
        displayName = "[Ghost] (US OCP) Modular Carrier JCA CQB";
        hiddenSelectionsTextures[] = {
            QPATHTOF(data\CarrierRigKBT_01_US_OCP_CO.paa),
            "",
            ""
        };
        picture = QPATHTOF(data\ui\Icon_CarrierRigKBT_01_cqb_US_OCP_F_CA.paa);
        MACRO_ITEM_COMMON
    };

    class GVAR(V_JCACrew_US_OCP): JCA_V_CarrierRigKBT_01_crew_olive_F {
        author = QAUTHOR;
        displayName = "[Ghost] (US OCP) Modular Carrier JCA Crew";
        hiddenSelectionsTextures[] = {
            QPATHTOF(data\CarrierRigKBT_01_US_OCP_CO.paa),
            ""
        };
        picture = QPATHTOF(data\ui\Icon_CarrierRigKBT_01_crew_US_OCP_F_CA.paa);
        MACRO_ITEM_COMMON
    };

    class GVAR(V_JCACommand_US_OCP): JCA_V_CarrierRigKBT_01_command_olive_F {
        author = QAUTHOR;
        displayName = "[Ghost] (US OCP) Modular Carrier JCA Command";
        hiddenSelectionsTextures[] = {
            QPATHTOF(data\CarrierRigKBT_01_US_OCP_CO.paa),
            "",
            "",
    ...
    class GVAR(V_JCAHolster_US_OCP): JCA_V_CarrierRigKBT_01_holster_olive_F {
        author = QAUTHOR;
        displayName = "[Ghost] (US OCP) Modular Carrier JCA Holster";
        hiddenSelectionsTextures[] = {
            QPATHTOF(data\CarrierRigKBT_01_US_OCP_CO.paa)
        };
        picture = QPATHTOF(data\ui\Icon_CarrierRigKBT_01_holster_US_OCP_F_CA.paa);
        MACRO_ITEM_COMMON
    };

    class GVAR(V_JCARecon_US_OCP): JCA_V_CarrierRigKBT_01_recon_olive_F {
        author = QAUTHOR;
        displayName = "[Ghost] (US OCP) Modular Carrier JCA Recon";
        hiddenSelectionsTextures[] = {
            QPATHTOF(data\CarrierRigKBT_01_US_OCP_CO.paa),
            "",
            ""
        };
        picture = QPATHTOF(data\ui\Icon_CarrierRigKBT_01_recon_US_OCP_F_CA.paa);
        MACRO_ITEM_COMMON
    };

    class GVAR(V_JCATactical_US_OCP): JCA_V_CarrierRigKBT_01_tactical_olive_F {
        author = QAUTHOR;
        displayName = "[Ghost] (US OCP) Modular Carrier JCA Tactical";
        hiddenSelectionsTextures[] = {
            QPATHTOF(data\CarrierRigKBT_01_US_OCP_CO.paa),
            "",
            "",
        ...
        picture = QPATHTOF(data\ui\Icon_CarrierRigKBT_01_tactical_US_OCP_F_CA.paa);
        MACRO_ITEM_COMMON
    };
