...
class CfgPatches {
    class ADDON {
        ...
        weapons[] = {
            ...
            QGVAR(V_CarrierSpec_US_OCP),
            QGVAR(V_CarrierGL_US_OCP),
            QGVAR(V_CarrierLite_US_OCP),
            QGVAR(V_CarrierRig_US_OCP),
            QGVAR(V_CarrierLiteNoBelt_US_OCP),
            QGVAR(V_Rangemaster_US_OCP),
            QGVAR(V_ChestRig_US_OCP),
            QGVAR(V_JCACompact_US_OCP),
            QGVAR(V_JCACQB_US_OCP),
            QGVAR(V_JCACrew_US_OCP),
            QGVAR(V_JCACommand_US_OCP),
            QGVAR(V_JCAHolster_US_OCP),
            QGVAR(V_JCARecon_US_OCP),
            QGVAR(V_JCATactical_US_OCP),
