...
// fox2
    ...
    class ghost_H_Booniehat_US_OCP: H_Booniehat_khk {
        author = QAUTHOR;
        hiddenSelections[] = {"camo"};
        displayName = "[Ghost] (US OCP) Booniehat";
        hiddenSelectionsTextures[] = {
            QPATHTOF(data\booniehat_US_OCP_co.paa)
        };
        picture = QPATHTOF(data\ui\icon_H_booniehat_US_OCP_ca.paa);
        MACRO_ITEM_COMMON
    };

    class ghost_H_Booniehat_US_OCP_hs: H_Booniehat_khk_hs {
        author = QAUTHOR;
        hiddenSelections[] = {"camo"};
        ...
        picture = QPATHTOF(data\ui\icon_H_Booniehat_US_OCP_hs_ca.paa);
        MACRO_ITEM_COMMON
    };

    class ghost_H_HelmetB_US_OCP: H_HelmetB {
        author = QAUTHOR;
        hiddenSelections[] = {"camo"};
        displayName = "[Ghost] (US OCP) Combat Helmet";
        hiddenSelectionsTextures[] = {
            QPATHTOF(data\equip1_US_OCP_co.paa)
        };
        picture = QPATHTOF(data\ui\icon_H_HelmetB_US_OCP_ca.paa);
        MACRO_ITEM_COMMON
    };

    class ghost_H_HelmetB_camo_US_OCP: H_HelmetB_camo {
        author = QAUTHOR;
        hiddenSelections[] = {"camo1", "camo2"};
        displayName = "[Ghost] (US OCP) Combat Helmet (Camo)";
        hiddenSelectionsTextures[] = {
            QPATHTOF(data\equip1_US_OCP_co.paa),
            QPATHTOF(data\ghillie_2_US_OCP_ca.paa)
        };
        picture = QPATHTOF(data\ui\icon_H_HelmetB_camo_US_OCP_ca.paa);
        MACRO_ITEM_COMMON
    };

    class ghost_H_HelmetSpecB_US_OCP: H_HelmetSpecB {
        author = QAUTHOR;
        hiddenSelections[] = {"camo"};
        ...
        picture = QPATHTOF(data\ui\icon_H_HelmetSpecB_US_OCP_ca.paa);
        MACRO_ITEM_COMMON
    };

    class ghost_H_HelmetB_light_basic_US_OCP: ghost_main_H_HelmetB_light_basic_base {
        author = QAUTHOR;
        Headlamps_Preset = "Headlamps_Preset_Helmet_Surefire_HL1_Left";
        hiddenSelections[] = {"camo"};
    ...
    class ghost_H_HelmetB_light_US_OCP: ghost_main_H_HelmetB_light_base {
        author = QAUTHOR;
        Headlamps_Preset = "Headlamps_Preset_Helmet_Surefire_HL1_Left";
        hiddenSelections[] = {"camo"};
        ...
        picture = QPATHTOF(data\ui\icon_H_HelmetB_light_US_OCP_ca.paa);
        MACRO_ITEM_COMMON
    };
