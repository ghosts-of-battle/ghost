class XtdGearModels {
    class CfgVehicles {
        class ghost_backpack_standard {
            ...
            class camo {
                alwaysSelectable = 1;
                values[] = {"Multicam", "Multicam_Snow", "Multicam_Woodland", "Solid_Black", "Solid_CoyoteBrown", "Solid_Olive", "Solid_Ranger_Green", "Solid_White", "US_DCU", "US_M81", "US_OCP"};
                ...
                class US_DCU { label = "DCU"; image = "z\aceax\addons\gearinfo\data\camo\khk.paa"; };
                class US_M81 { label = "M81"; image = "z\aceax\addons\gearinfo\data\camo\m81.paa"; };
                class US_OCP { label = "OCP"; image = "z\aceax\addons\gearinfo\data\camo\mc.paa"; };
            };
        ...
        class ghost_backpack_radiobag {
            ...
            class camo {
                alwaysSelectable = 1;
                values[] = {"Multicam", "Multicam_Snow", "Multicam_Woodland", "Solid_Black", "Solid_CoyoteBrown", "Solid_Olive", "Solid_Ranger_Green", "Solid_Tan", "Solid_White", "US_DCU", "US_M81"};
...
class XtdGearInfos {
    class CfgVehicles {
        ...
        class GVAR(AssaultPack_US_DCU) { model = "ghost_backpack_standard"; camo = "US_DCU"; type = "assault"; };
        class GVAR(AssaultPack_US_M81) { model = "ghost_backpack_standard"; camo = "US_M81"; type = "assault"; };
        class GVAR(AssaultPack_US_OCP) { model = "ghost_backpack_standard"; camo = "US_OCP"; type = "assault"; };
        ...
        class GVAR(AssaultPackEnhanced_US_DCU) { model = "ghost_backpack_standard"; camo = "US_DCU"; type = "assault_enhanced"; };
        class GVAR(AssaultPackEnhanced_US_M81) { model = "ghost_backpack_standard"; camo = "US_M81"; type = "assault_enhanced"; };
        class GVAR(AssaultPackEnhanced_US_OCP) { model = "ghost_backpack_standard"; camo = "US_OCP"; type = "assault_enhanced"; };
        ...
        class GVAR(Carryall_US_DCU) { model = "ghost_backpack_standard"; camo = "US_DCU"; type = "carryall"; };
        class GVAR(Carryall_US_M81) { model = "ghost_backpack_standard"; camo = "US_M81"; type = "carryall"; };
        class GVAR(Carryall_US_OCP) { model = "ghost_backpack_standard"; camo = "US_OCP"; type = "carryall"; };
        ...
        class GVAR(Kitbag_US_DCU) { model = "ghost_backpack_standard"; camo = "US_DCU"; type = "kitbag"; };
        class GVAR(Kitbag_US_M81) { model = "ghost_backpack_standard"; camo = "US_M81"; type = "kitbag"; };
        class GVAR(Kitbag_US_OCP) { model = "ghost_backpack_standard"; camo = "US_OCP"; type = "kitbag"; };
        ...
        class GVAR(TacticalPack_US_DCU) { model = "ghost_backpack_standard"; camo = "US_DCU"; type = "tactical"; };
        class GVAR(TacticalPack_US_M81) { model = "ghost_backpack_standard"; camo = "US_M81"; type = "tactical"; };
        class GVAR(TacticalPack_US_OCP) { model = "ghost_backpack_standard"; camo = "US_OCP"; type = "tactical"; };
        ...
        class GVAR(FieldPack_US_OCP) { model = "ghost_backpack_field"; camo = "US_OCP"; type = "fieldpack"; };
        class GVAR(Bergen_US_OCP) { model = "ghost_backpack_field"; camo = "US_OCP"; type = "bergen"; };
        ...
        class GVAR(B_RadioBag_01_US_DCU) { model = "ghost_backpack_radiobag"; camo = "US_DCU"; };
        class GVAR(B_RadioBag_01_US_M81) { model = "ghost_backpack_radiobag"; camo = "US_M81"; };
    };
};
