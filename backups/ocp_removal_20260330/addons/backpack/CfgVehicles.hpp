class CfgVehicles {
    ...
    class GVAR(B_RadioBag_01_Multicam): GVAR(RadioBag_01_Base) {
        author = QAUTHOR;
        displayName = "[Ghost](Multicam) Radio Pack";
    ...
    class GVAR(B_RadioBag_01_Multicam_Snow): GVAR(RadioBag_01_Base) {
        author = QAUTHOR;
        displayName = "[Ghost](Multicam Snow) Radio Pack";
    ...
    class GVAR(B_RadioBag_01_Multicam_Woodland): GVAR(RadioBag_01_Base) {
        author = QAUTHOR;
        displayName = "[Ghost](Multicam Woodland) Radio Pack";
    ...
    class GVAR(B_RadioBag_01_Solid_Black): GVAR(RadioBag_01_Base) {
        author = QAUTHOR;
        displayName = "[Ghost](Black) Radio Pack";
    ...
    class GVAR(B_RadioBag_01_Solid_CoyoteBrown): GVAR(RadioBag_01_Base) {
        author = QAUTHOR;
        displayName = "[Ghost](CoyoteBrown) Radio Pack";
    ...
    class GVAR(B_RadioBag_01_Solid_Olive): GVAR(RadioBag_01_Base) {
        author = QAUTHOR;
        displayName = "[Ghost](Olive) Radio Pack";
    ...
    class GVAR(B_RadioBag_01_Solid_Ranger_Green): GVAR(RadioBag_01_Base) {
        author = QAUTHOR;
        displayName = "[Ghost](Ranger Green) Radio Pack";
    ...
    class GVAR(B_RadioBag_01_Solid_Tan): GVAR(RadioBag_01_Base) {
        author = QAUTHOR;
        displayName = "[Ghost](Tan) Radio Pack";
    ...
    class GVAR(B_RadioBag_01_Solid_White): GVAR(RadioBag_01_Base) {
        author = QAUTHOR;
        displayName = "[Ghost](White) Radio Pack";
    ...
    class GVAR(B_RadioBag_01_US_DCU): GVAR(RadioBag_01_Base) {
        author = QAUTHOR;
        displayName = "[Ghost](DCU) Radio Pack";
    ...
    class GVAR(B_RadioBag_01_US_M81): GVAR(RadioBag_01_Base) {
        author = QAUTHOR;
        displayName = "[Ghost](US_M81) Radio Pack";
    ...
    //End radios 
    class GVAR(AssaultPack_US_OCP): B_AssaultPack_rgr {
        author = QAUTHOR;
        maximumLoad = 240;
        displayName = "[Ghost] (US OCP) Assault Pack";
        hiddenSelectionsTextures[] = {
            QPATHTOF(data\backpack_compact_US_OCP_co.paa)
        };
        picture = QPATHTOF(data\ui\icon_B_AssaultPack_US_OCP_ca.paa);
        MACRO_ITEM_COMMON
    };

    class GVAR(AssaultPackEnhanced_US_OCP): B_AssaultPack_Kerry {
        author = QAUTHOR;
        maximumLoad = 240;
        displayName = "[Ghost] (US OCP) Assault Pack (Enhanced)";
        hiddenSelectionsTextures[] = {
            QPATHTOF(data\backpack_compact_US_OCP_co.paa),
            QPATHTOF(data\vests_US_OCP_co.paa)
        };
        picture = QPATHTOF(data\ui\icon_B_AssaultPack_US_OCP_ca.paa);
        MACRO_ITEM_COMMON
        model = "\A3\Characters_F_EPA\BLUFOR\backpack_kerry.p3d";
    ...
    class GVAR(Carryall_US_OCP): B_Carryall_cbr {
        author = QAUTHOR;
        hiddenSelections[] = {"Camo"};
        maximumLoad = 240;
        displayName = "[Ghost] (US OCP) Carryall Backpack";
        hiddenSelectionsTextures[] = {
            QPATHTOF(data\backpack_tortila_US_OCP_co.paa)
        };
        picture = QPATHTOF(data\ui\icon_B_C_Tortila_US_OCP.paa);
        MACRO_ITEM_COMMON
    };

    class GVAR(Kitbag_US_OCP): B_Kitbag_rgr {
        author = QAUTHOR;
        hiddenSelections[] = {"Camo"};
        maximumLoad = 240;
        displayName = "[Ghost] (US OCP) Kitbag";
        hiddenSelectionsTextures[] = {
            QPATHTOF(data\backpack_fast_US_OCP_co.paa)
        };
        picture = QPATHTOF(data\ui\icon_B_C_Kitbag_US_OCP.paa);
        MACRO_ITEM_COMMON
    };

    class GVAR(TacticalPack_US_OCP): B_TacticalPack_blk {
        author = QAUTHOR;
        hiddenSelections[] = {"Camo"};
        maximumLoad = 240;
        displayName = "[Ghost] (US OCP) Tactical Backpack";
        hiddenSelectionsTextures[] = {
            QPATHTOF(data\backpack_small_US_OCP_co.paa)
        };
        picture = QPATHTOF(data\ui\icon_B_C_Small_US_OCP.paa);
        MACRO_ITEM_COMMON
    };
    ...
    class GVAR(FieldPack_Multicam): B_FieldPack_oli {
        ...
        picture = QPATHTOF(data\ui\icon_B_C_Gorod_Multicam_ca.paa);
        MACRO_ITEM_COMMON
    };
    ...
    class GVAR(Bergen_Multicam): B_Bergen_mcamo_F {
        ...
        picture = QPATHTOF(data\ui\Icon_B_Bergen_Multicam_CA.paa);
        MACRO_ITEM_COMMON
    };
    ...
    class GVAR(FieldPack_Multicam_Snow): B_FieldPack_oli {
        ...
        picture = QPATHTOF(data\ui\icon_B_C_Gorod_Multicam_Snow_ca.paa);
        MACRO_ITEM_COMMON
    };
    ...
    class GVAR(Bergen_Multicam_Snow): B_Bergen_mcamo_F {
        ...
        picture = QPATHTOF(data\ui\Icon_B_Bergen_Multicam_Snow_CA.paa);
        MACRO_ITEM_COMMON
    };
    ...
    class GVAR(FieldPack_Multicam_Woodland): B_FieldPack_oli {
        ...
        picture = QPATHTOF(data\ui\icon_B_C_Gorod_A3_Multicam_Woodland_ca.paa);
        MACRO_ITEM_COMMON
    };
    ...
    class GVAR(Bergen_Multicam_Woodland): B_Bergen_mcamo_F {
        ...
        picture = QPATHTOF(data\ui\Icon_B_Bergen_A3_Multicam_Woodland_CA.paa);
        MACRO_ITEM_COMMON
    };

    class GVAR(FieldPack_US_OCP): B_FieldPack_oli {
        author = QAUTHOR;
        hiddenSelections[] = {"Camo"};
        maximumLoad = 240;
        displayName = "[Ghost] (US OCP) Field Pack";
        hiddenSelectionsTextures[] = {
            QPATHTOF(data\backpack_gorod_US_OCP_co.paa)
        };
        picture = QPATHTOF(data\ui\icon_B_C_Gorod_US_OCP_ca.paa);
        MACRO_ITEM_COMMON
    };

    class GVAR(Bergen_US_OCP): B_Bergen_mcamo_F {
        author = QAUTHOR;
        hiddenSelections[] = {"camo"};
        maximumLoad = 240;
        displayName = "[Ghost] (US OCP) Bergen Backpack";
        hiddenSelectionsTextures[] = {
            QPATHTOF(data\Bergen_US_OCP_co.paa)
        };
        picture = QPATHTOF(data\ui\Icon_B_Bergen_US_OCP_CA.paa);
        MACRO_ITEM_COMMON
    };
