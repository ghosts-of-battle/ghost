    ...
    class CfgWeapons {
        class opscoreHighCut {
            ...
            class camo {
                label = "Camo";
                alwaysSelectable = 1;
                values[] = {"blk", "gry", "mcbk", "rgr", "od", "coy", "tan", "mc", "mcwdl", "mctp", "mcarid", "m81", "mtp", "dpm", "nightdesert", "digital", "geometric", "tan_snake", "coy_snake", "od_snake", "rgr_snake", "alt_mc"};
                class blk {
                    label = "Black";
