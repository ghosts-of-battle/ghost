class XtdGearModels {
    class CfgWeapons {
        class ghost_H_Booniehat {
            ...
            class camo {
                alwaysSelectable = 1;
                values[] = { "Multicam", "Multicam_Snow", "Multicam_Woodland", "Solid_Black", "Solid_CoyoteBrown", "Solid_Olive", "Solid_Ranger_Green", "Solid_Tan", "Solid_White", "US_M81" };
                class Solid_Black {
                    label = "BLK";
        ...
        class wrp_headgear_opscore {
            ...
            class camo {
                alwaysSelectable = 1;
                values[] = { "aor1", "aor2", "blk", "khk", "mc", "mca", "mcb", "mct", "rgr" };
                class aor1 {
                    label = "AOR1";
